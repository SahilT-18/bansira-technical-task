...
helm.sh/chart: {{ include "hello-world-node.chart" . }}
...
*/}}
{{- define "hello-world-node.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "hello-world-node.fullname" .) .Values.serviceAccount.name }}
{{- else }}
